...
THREE.GPUParticleSystem = function(options) {
  ...
  self.particleNoiseTex = THREE.ImageUtils.loadTexture("../libraries/textures/perlin-512.png");
  self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

  self.particleSpriteTex = THREE.ImageUtils.loadTexture("../libraries/textures/particle2.png");
